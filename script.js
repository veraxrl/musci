...
app.controller('UserCtrl', function($scope, $http, $firebaseArray, $firebaseObject, $firebaseAuth, $location, $routeParams, currentAuth) {
	//filter by user fnctn
	console.log($routeParams.userIdent);

	var usrRef = firebase.database().ref().child("tracks").child($routeParams.userIdent);
	$scope.tracks = $firebaseArray(usrRef);
	console.log($scope.tracks);
	$scope.userIdent = currentAuth.uid;

	//store user info in firebase
	var logUserRef = firebase.database().ref().child('users');
	$scope.users = $firebaseObject(logUserRef);
...
app.controller('mainCtrl', function($scope, $http, $firebaseArray, $firebaseObject, $firebaseAuth, $location, $routeParams, currentAuth) {
